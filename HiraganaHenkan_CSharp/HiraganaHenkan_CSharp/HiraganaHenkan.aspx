<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HiraganaHenkan.aspx.cs" Inherits="HiraganaHenkan_CSharp.HiraganaHenkan" %>
        ...
        <div>
            <table>
                ...
                <tbody>
                    <tr>
                        <td>
                            <asp:Label ID="PathLabel" runat="server" Text=""></asp:Label></td>
                    </tr>
                    <tr>
                        <td>
